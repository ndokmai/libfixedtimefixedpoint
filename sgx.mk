...
SGX_COMMON_FLAGS += -Wall -Wextra -Winit-self -Wpointer-arith -Wreturn-type \
                    ...
                    -Wcast-align -Wcast-qual -Wno-sign-compare
...
libs_sgx := libftfp_sgx.a 
ifeq ($(SGX), 1)
    libs := $(libs_sgx)
    CFLAGS += $(SGX_COMMON_CFLAGS) $(Enclave_C_Flags) -DSGX
endif
